...
LOCALIZED_MESSAGES = {
    ...
    "lang_ru": {
        "lang_selected": "✅ Язык выбран!\n\nВведите свой вопрос по госзакупкам, законодательству или финансам:",
...
async def language_chosen(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(LOCALIZED_MESSAGES[lang]["lang_selected"])
...
5. Рақамли рўйхат билан аниқ жавоб беринг"""
    ...
    try:
        ...
        await update.message.reply_text(LOCALIZED_MESSAGES[lang]["error"])
