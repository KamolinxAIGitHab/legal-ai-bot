...
LOCALIZED_MESSAGES = {
    "lang_uz_cyr": {
        ...
        "disclaimer": "Жавоблар умумий ва таълимий мақсадда.",
        "error_api": "❌ API калити билан муаммо.",
    ...
    "lang_uz_lat": {
        ...
        "disclaimer": "Javoblar umumiy va ta'limiy maqsadda.",
        "error_api": "❌ API kaliti bilan muammo.",
    ...
    "lang_ru": {
        ...
        "success": "✅ Язык выбран!\n\nНапишите ваш вопрос:",
        "disclaimer": "Ответы носят ознакомительный характер.",
        "error_api": "❌ Проблема с API ключом.",
...
4. Если не уверены — напишите: Обратитесь к официальному источнику"""
    ...
    try:
        ...
        print(f"XATO: {e}")
        await wait_msg.edit_text(f"{msgs['error_gen']}{type(e).__name__}")
