...
MESSAGES = {
    "lang_uz_cyr": {"wait": "⏳ Жавоб тайёрланмоқда...", "success": "✅ Тил танланди!\n\nДавлат харидлари, қонунчилик ёки молия бўйича саволингизни ёзинг:", "disclaimer": "⚠️ Жавоблар умумий ва таълимий мақсадда."},
    "lang_uz_lat": {"wait": "⏳ Javob tayyorlanmoqda...", "success": "✅ Til tanlandi!\n\nDavlat xaridlari, qonunchilik yoki moliya bo'yicha savolingizni yozing:", "disclaimer": "⚠️ Javoblar umumiy va ta'limiy maqsadda."},
    "lang_ru": {"wait": "⏳ Ответ готовится...", "success": "✅ Язык выбран!\n\nЗадайте свой вопрос по госзакупкам, законодательству или финансам:", "disclaimer": "⚠️ Ответы носят общий и образовательный характер."}
}
...
async def language_chosen(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(MESSAGES.get(lang, MESSAGES["lang_uz_cyr"])["success"])
...
4. Если не уверены — напишите: Обратитесь к официальному источнику"""
    ...
    try:
        if not CLAUDE_API_KEY:
            await wait_msg.edit_text("❌ CLAUDE_API_KEY missing.")
            return
