...
L = {
    "lang_uz_cyr": {"ok": "✅ Тил танланди!\n\nСаволингизни ёзинг:", "wait": "⏳ Жавоб тайёрланмоқда...", "warn": "⚠️ Жавоблар умумий ва таълимий мақсадда.", "err": "❌ Хатолик юз берди. Кейинроқ уриниб кўринг."},
    "lang_uz_lat": {"ok": "✅ Til tanlandi!\n\nSavolingizni yozing:", "wait": "⏳ Javob tayyorlanmoqda...", "warn": "⚠️ Javoblar umumiy va ta'limiy maqsadda.", "err": "❌ Xatolik yuz berdi. Keyinroq urinib ko'ring."},
    "lang_ru": {"ok": "✅ Язык выбран!\n\nНапишите ваш вопрос:", "wait": "⏳ Ответ готовится...", "warn": "⚠️ Ответы носят ознакомительный характер.", "err": "❌ Произошла ошибка. Попробуйте позже."},
}
